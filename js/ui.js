...
ZenPen.ui = (function () {
  ...
  function init() {
    ...
    console.log(
      "Checkin under the hood eh? We've probably got a lot in common. You should totally check out ZenPen on github! (https://github.com/tholman/zenpen)."
    );
  }
    ...
    fetch(header_url, requestOptions)
      .then(function (response) {
        ...
        response.json().then(function (data) {
          ...
          let isDarkLayout = data["items"].filter(function (e) {
            return e.key === "darkLayout";
          });
          ...
          else if (!(isDarkLayout.length === 0) && isDarkLayout[0]["value"] === true) {
            console.log(darkLayout, isDarkLayout);
            if (darkLayout === false) {
